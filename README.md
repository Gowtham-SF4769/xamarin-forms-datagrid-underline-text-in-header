# xamarin-forms-datagrid-underline-text-in-header
This example illustrates how to underline the text in header of Xamarin.Forms DataGrid (SfDataGrid).

If you’re new to SfDataGrid, see the official overview: [Overview of Xamarin DataGrid (SfDataGrid)](https://help.syncfusion.com/xamarin/datagrid/overview)
